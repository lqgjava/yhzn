...
function Calendar_Show(year,month,day)
{
 ...
 '<li style="width:144px;background:#FFF;padding-bottom:1px;" id="SelectArea"><iframe src="" style="width:800px;height:536px;top:0px;left:0px;position:absolute;visibility:inherit;z-index:-1;" frameborder=0></iframe> <div id="sYear">'+year+'年</div><div id="SArr" onclick="ShowSelect(\'SelectYear\',\'Y\');"><font face="Webdings">6</font></div>'+
