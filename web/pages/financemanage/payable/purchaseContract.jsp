	...
	<div class="panel">
				...
				<table border="0" width="100%" cellpadding="0">
					...
					<tr height="35px;">
						...
						<td width="70%" align="left"><input name="money" value="0"
							class="easyui-textbox" size="50px" style="width: 84%;"
							required="true" />元</td>
					</tr>
					<tr height="35px;">
					...
					<tr height="80px;">
						...
						<td width="70%" align="left"><input class="easyui-textbox"
							data-options="multiline:true" size="35px"
							style="height:150px;width:200px;" name="remark"></td>
					</tr>
				</table>
			</form>
		</div>
				...
				<table border="0" width="100%" cellpadding="0">
					...
					<tr height="35px;">
						...
						<td width="70%" align="left"><input name="money" id="money"
							class="easyui-textbox" size="33px" required="true"
							style="width: 84%;" />元</td>
					</tr>
					<tr height="35px;">
						<td width="30%" height="35px;" align="right">已付金额：</td>
						<td width="70%" align="left"><input name="payMoney"
							id="payMoney" value="0" class="easyui-textbox" size="33px"
							style="width: 84%;" />元</td>
					</tr>
					<tr height="35px;">
						<td width="30%" height="35px;" align="right">合同名称：</td>
						<td width="70%" align="left"><input name="contractName"
							id="contractName" class="easyui-textbox" size="35px"
							style="width: 86%;" /></td>
					</tr>
					<tr height="35px;">
						<td width="30%" height="35px;" align="right">合同编号：</td>
						<td width="70%" align="left"><input name="contractNo"
							id="contractNo" class="easyui-textbox" size="35px"
							style="width: 86%;" /></td>
					</tr>
					<tr height="35px;">
						<td width="30%" height="35px;" align="right">签订时间：</td>
					...
					<tr height="80px;">
						...
						<td width="70%" align="left"><input class="easyui-textbox"
							data-options="multiline:true" size="35px"
							style="height:150px;width:200px;" name="remark" id="remark"></td>
					</tr>
				</table>
			</form>
		</div>
		...
		<script>
			...
			function linkForm(contractNo) {
				/* window.location.href="${ctx}/purchasedetails/purchaseDetails"; */
					// 创建窗口
					var content = "<iframe src='${ctx}/purchasedetails/purchaseDetails' width='100%' height='99%' frameborder='0' scrolling='no'></iframe>";
